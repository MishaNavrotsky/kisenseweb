...
(async function () {
    loader.load("/games/Robocook/images/robot sit.png")
    loader.load("/games/Robocook/images/icicle.png")
    loader.load("/games/Robocook/images/background ice all.png")
    let ingsNames = [
        "cheese",
        "eggs",
        "flour",
    ...
    for (const i of ingsNames) {
        loader.load("/games/Robocook/images/ingredients/" + i + ".png");
    }

    loader.loaded().then(async (arr) => {
        let lastTime;
        const moveObject = new ImageMoveGameObject(0, 0);
        moveObject.sprite = await loader.sprites["/games/Robocook/images/background ice all.png"];
        ...
        enemySpawnInterval.onTime = async () => {
            ...
            enemy.sprite = await loader.sprites["/games/Robocook/images/icicle.png"];
